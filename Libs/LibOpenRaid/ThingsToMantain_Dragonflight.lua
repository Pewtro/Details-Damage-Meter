...
do
	...
	local loadLibDatabase = function()
		...
		LIB_OPEN_RAID_FOOD_BUFF = {
			...
			[382155] = {
				tier = {[130] = 1},
				status = {"critical", "versatility"},
				localized = {STAT_CRITICAL_STRIKE, STAT_VERSATILITY}
			}, --Well Fed crit + vers 130
		...
		LIB_OPEN_RAID_COOLDOWNS_INFO = {
			...
			[255647] = {
				...
				class = "",
				type = 9
			}, --Light's Judgment (LightforgedDraenei)
			[256948] = {
				cooldown = 180,
				duration = 0,
				specs = {},
			...
			[6552] = {
				...
				silence = 4,
				talent = false,
				cooldownWithTalent = false,
				cooldownTalentId = false,
				type = 6,
				charges = 1
			}, --Pummel
			[2139] = {
			...
			[15487] = {
				...
				silence = 4,
				talent = false,
				cooldownWithTalent = 30,
				cooldownTalentId = 23137,
				type = 6,
				charges = 1
			}, --Silence (shadow) Last Word Talent to reduce cooldown in 15 seconds
			[1766] = {
				class = "ROGUE",
				specs = {259, 260, 261},
				cooldown = 15,
			...
			[96231] = {
				...
				type = 6,
				charges = 1
			}, --Rebuke (protection and retribution)
			[116705] = {
				class = "MONK",
				specs = {268, 269},
				cooldown = 15,
				...
				type = 6,
				charges = 1
			}, --Spear Hand Strike (brewmaster and windwalker)
			[57994] = {
				class = "SHAMAN",
				specs = {262, 263, 264},
				cooldown = 12,
			...
			[147362] = {
				...
				type = 6,
				charges = 1
			}, --Counter Shot (beast mastery, marksmanship)
			[187707] = {
				class = "HUNTER",
				specs = {255},
				cooldown = 15,
			...
			[19647] = {
				...
				type = 6,
				charges = 1
			}, --Spell Lock (pet felhunter ability)
			[132409] = {
				class = "WARLOCK",
				specs = {},
				cooldown = 24,
				...
				type = 6,
				charges = 1
			}, --Spell Lock with felhunter Sacrified by Grimeoire of Sacrifice
			[89766] = {
				class = "WARLOCK",
				specs = {266},
				cooldown = 30,
